...
#This function return the path of the search
        ...
        while len(yet_to_visit_list) > 0:
            ...
            for index, item in enumerate(yet_to_visit_list):
                if item.f < current_node.f:
                    current_node = item
                    current_index = index
            self.addPathToMaze(self.return_path(current_node,self.maze))
            self.printMazeXY()                
            ...
            for new_position in move: 
                ...
                if self.maze[node_position[0]][node_position[1]] != 'c':
                    continue
    ...
    def printMazeXY(self):
        os.system("cls")
        height, width = np.shape(self.maze)
    ...
    def solveMaze(self):
        ...
        self.addPathToMaze(self.search(start, end))
        self.printMazeXY()
